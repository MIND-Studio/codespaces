  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-16 sm:px-10">
      ...
      <p className="mt-5 max-w-2xl leading-relaxed text-[color:var(--ink-soft)]">
        That URL doesn&apos;t resolve to anything the bridge knows about. The
        repo, run, pull, or page may have been renamed, never existed, or
        lives on a different Solid Pod entirely.
      </p>
